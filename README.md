...
**[<img src="./docs/target-dart.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Problem}}$](#-the-problem) · [<img src="./docs/sliders-horizontal.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Features}}$](#-features) · [<img src="./docs/clipboard-check-custom.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Evaluation Criteria}}$](#-how-roadsos-meets-each-evaluation-criterion) · [<img src="./docs/architecture-custom.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Architecture}}$](#-architecture) · [<img src="./docs/rocket-custom.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Quick Start}}$](#-quick-start) · [<img src="https://api.iconify.design/lucide/mic.svg?color=%233b82f6" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Walkthrough}}$](#-three-minute-walkthrough) · [<img src="./docs/file-text-custom.svg" width="16" height="16" align="absmiddle" /> $\color{white}{\textsf{Docs}}$](https://github.com/Arthrevs/RoadSOS/blob/main/docs)**
