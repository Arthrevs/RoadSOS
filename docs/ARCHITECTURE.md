...
│  └─ Bundled facilities JSON (315 records, 196 countries)            │
└────────────────────────────┬────────────────────────────────────────┘
                             │ HTTPS
                             ▼
┌─────────────────────────────────────────────────────────────────────┐
...
mount
  ...
  └─ langPickerOpen?               ┐
        ...
        │     bundled_facilities.json (315 recs,     │
        │     80km → 600km fallback)                 │
...
| `bundled_facilities.json` | 315 emergency facilities × 196 countries | build-time | new build |
...
**Decision:** Ship 315-record facility catalog with the app (`bundled_facilities.json`, ~50KB gzipped).
