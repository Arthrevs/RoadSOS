...
|   `- bundled JSON     (315 facilities x 196 countries)        |
+----------------------------+----------------------------------+
...
When network requests fail and no cache entry exists, \file{src/utils/bundledFacilities.js} computes the nearest entries from a JSON file shipped in the build bundle: \file{src/data/bundled\_facilities.json} (315 records, 196 countries).
