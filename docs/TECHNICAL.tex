...
|   `- bundled JSON     (818 entries x 200 countries)          |
+----------------------------+----------------------------------+
...
When network requests fail and no cache entry exists, \file{src/utils/bundledFacilities.js} computes the nearest entries from a JSON file shipped in the build bundle: \file{src/data/bundled\_facilities.json} (818 entries, 200 countries).
...
|     `- data/
|        `- bundled_facilities.json # 818 entries, 200 countries
|
|- docs/
